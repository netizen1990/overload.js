...
class LoadTestEngine {
    ...
    async start() {
        ...
        console.log(`Starting load test against ${this.target}`);
    ...
    startMonitoring() {
        const interval = setInterval(() => {
            ...
            process.stdout.write(`\rRequests: ${summary.totalRequests} | Success: ${summary.successfulRequests} | Failed: ${summary.failedRequests} | Rate: ${summary.throughput}`);
        }, 1000);
    }
